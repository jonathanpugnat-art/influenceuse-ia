...
const nicheSuggestions: Record<string, string[]> = {
  FITNESS: ["Legging + brassière", "Tenue yoga", "Bikini sportif"],
  FASHION: ["Robe noire élégante", "Tailleur oversize", "Robe de soirée"],
  TRAVEL: ["Robe bohème", "Short + top léger", "Tenue safari"],
  FOOD: ["Tablier chef", "Tenue casual chic", "Robe cuisine"],
  LIFESTYLE: ["Pyjama soie", "Tenue loungewear", "Jean + blazer"],
  GAMING: ["Hoodie gaming", "T-shirt geek", "Cosplay"],
  TECH: ["Tenue corporate", "Smart casual", "Streetwear tech"],
  ADULT: ["Lingerie dentelle", "Bikini", "Robe transparente"],
};
...
export function PhotoParams() {
  ...
  const outfitSuggestions = nicheSuggestions[selectedNiche] ?? [];
  ...
  return (
    <div className="h-full overflow-y-auto border-r border-slate-800/50 bg-slate-900/30 p-4 scrollbar-thin">
      ...
      <div className="space-y-5">
        ...
        {/* NSFW section — only if influencer is NSFW */}
